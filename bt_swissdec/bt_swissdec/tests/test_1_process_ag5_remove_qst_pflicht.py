...
class TestProcessAG5RemoveQstPflicht(TestBTSwissdec):
    ...
    def test_remove_qst_pflicht(self):
        ...
        create_dump_name = '1_remove'
        create_dump_name = False
        xml_name_to_save = '1_remove_qst_pflicht_test.xml'
